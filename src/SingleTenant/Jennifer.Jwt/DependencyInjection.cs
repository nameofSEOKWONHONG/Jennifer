...
public static class DependencyInjection
{
    ...
    public static void WithJenniferHybridCache(this IServiceCollection services,
    ...
    public static void WithJenniferAuthHub(this IServiceCollection services, Action<RedisOptions> redisOptions)
    {
