...
namespace Jennifer.Tenant.Migrations
{
    ...
    partial class TenantJenniferDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jennifer.Tenant.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Jennifer.Tenant.Models.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Jennifer.Tenant.Models.UserLogin", b =>
                {
            ...
            modelBuilder.Entity("Jennifer.Tenant.Models.UserRole", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Jennifer.Tenant.Models.UserToken", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Jennifer.Tenant.Models.UserClaim", b =>
                {
                    b.HasOne("Jennifer.Tenant.Models.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Jennifer.Tenant.Models.UserLogin", b =>
                {
                    b.HasOne("Jennifer.Tenant.Models.User", "User")
                        .WithMany("Logins")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
