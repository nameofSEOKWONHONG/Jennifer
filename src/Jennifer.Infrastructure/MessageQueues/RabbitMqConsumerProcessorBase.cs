...
public class RabbitMqConsumerProcessorBase : BackgroundService, IAsyncDisposable
{
    private readonly ILogger<RabbitMqConsumerProcessorBase> _logger;
    ...
    public RabbitMqConsumerProcessorBase(ILogger<RabbitMqConsumerProcessorBase> logger, string exchangeName)
    {
        _logger = logger;
